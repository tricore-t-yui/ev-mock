...
namespace nn.friends
{
    ...
    public struct UserPresence
    {
        ...
        public nn.Result SetDescription(string description)
        {
            return SetDescription(ref this, description, description.Length);
        }
        ...
        private static extern nn.Result SetDescription(ref UserPresence pUserPresence, [MarshalAs(UnmanagedType.LPStr), In] string description, long size);
#endif
    }
